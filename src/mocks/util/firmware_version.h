// Shadow header for util/firmware_version.h
// The real header is a .h.in CMake template with substitution variables.
// This is based on firmware/tests/32bit_unit_tests/mocks/util/firmware_version.h
// with hardcoded version 0.0.0.
...
struct FirmwareVersion {
	...
	constexpr static FirmwareVersion current() {
		return FirmwareVersion(Type::COMMUNITY, {0, 0, 0});
	};
